...
Documentos legais de **Dicelash** (`com.uaigames.dicelash`) — publicados via GitHub Pages.
...
2. A URL fica `https://caixeta94.github.io/Dicelash-Legal/`

## URLs para a ficha da Play Store

| Campo do Play Console | URL |
|---|---|
| Política de Privacidade | `https://caixeta94.github.io/Dicelash-Legal/privacidade.html` |
| Exclusão de conta (Data safety) | `https://caixeta94.github.io/Dicelash-Legal/exclusao-de-conta.html` |
| Site do desenvolvedor | `https://caixeta94.github.io/Dicelash-Legal/` |
...
- [ ] Os flags de feature em `games.json` batem com o que o app **realmente faz**
      (hoje: `leaderboard, replay, ghost, async_duel, iap, ads, gacha, cloud_save, seasons, analytics`). Data Safety divergente do comportamento real é a causa
